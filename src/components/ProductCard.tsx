...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
    <div className="bg-white  shadow-2xl max-w-3xl w-full flex flex-col md:flex-row overflow-hidden relative">
      ...
      {/* Close Button */}
      <button
        className="absolute top-6 right-6 flex items-center justify-center w-10 h-10 rounded-full bg-black/10 hover:bg-primary/20 text-black hover:text-primary transition-colors duration-200 shadow-lg"
